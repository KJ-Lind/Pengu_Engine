...
namespace Pengu::Scene {
	...
	void LightScene::onLoad(Pengu::Resources::ResourceManager& rm)
	{
		...
		getWorld().AddComponent(player, TagComponent("Player"));
		...
		getWorld().AddComponent(floor, TagComponent("Floor"));
		...
		getWorld().AddComponent(box, TagComponent("Box 1"));
		...
		getWorld().AddComponent(box, TransformComponent(glm::vec3(-5.0f, 0.0f, 0.0f), glm::vec3(1.0f), glm::vec3(0.0f)));
		getWorld().AddComponent(box, TagComponent("Box 2"));
		...
		getWorld().AddComponent(panel, TagComponent("Panel"));
